...
public class CodeGenerator {
    ...
    // 填你的数据库名称
    private static final String DATASOURCE = "hosp_vaccine_system";
    
    // 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
    private static final String basePath = "C:\\Users\\Administrator\\Desktop\\FY-Project\\社区医院疫苗管理系统\\springboot";

    // 数据库需要生成代码的表名
    private static final String tableName = "notice";
    // 生成页面的菜单名称
    private static final String modelName = "系统公告";

    // ----------------------------------------以上必修修改-----------------------------------------

    // 数据库密码 （填你自己的密码，默认 123456）
    private static final String PASSWORD = "cxc123456";
