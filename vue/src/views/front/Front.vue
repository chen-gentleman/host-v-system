...
<!--          <img src="../../assets/logo1.png" alt="" style="width: 50px; position: relative; top: 5px; right: 0">-->
      ...
      <div style="flex: 1">
        ...
        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" router>
          ...
          <el-menu-item index="/front/posts">我要发帖</el-menu-item>
            <el-menu-item index="/front/myposts">我的帖子</el-menu-item>
            <el-menu-item index="/front/mycomment">我评论的帖子</el-menu-item>
            <el-menu-item index="/front/mycollect">我收藏的帖子</el-menu-item>
        </el-menu>
      </div>
