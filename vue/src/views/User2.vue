...
<!--      <el-table-column label="角色">
      ...
      <el-table-column prop="sex" label="性别" :formatter="formSex"></el-table-column>
      <el-table-column prop="phone" label="电话"></el-table-column>
      <el-table-column prop="age" label="年龄"></el-table-column>
      <el-table-column prop="birthday" :formatter="formDa" label="出生日期"></el-table-column>
...
export default {
  ...
  methods: {
    load() {
      this.request.get("/user/pageDoct", {
        params: {
    ...
    formDa(row, column, cellValue, index) {
